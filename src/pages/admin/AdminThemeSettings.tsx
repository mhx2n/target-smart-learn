...
const AdminThemeSettings = () => {
  ...
  const selectPreset = (id: string) => {
    ...
    if (!preset) return;
    setSettings((prev) => ({ ...prev, activeThemeId: id }));
    ...
    <div className="animate-fade-in max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold flex items-center gap-2">
          <Palette size={22} className="text-primary" /> থিম কাস্টমাইজার
        </h1>
      ...
      <div className="glass-card-static p-5 space-y-4 mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            ...
            <input
              value={settings.brandEmoji}
              onChange={(e) => setSettings((p) => ({ ...p, brandEmoji: e.target.value }))}
              className="w-full glass-strong rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
            />
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={`relative p-4 rounded-xl border-2 transition-all text-left ${
                  isActive ? "border-primary shadow-lg scale-[1.02]" : "border-border hover:border-primary/40"
                }`}
              >
                {isActive && (
                  ...
                  <div key={field.key} className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => updateCustomColor(currentMode, field.key, e.target.value)}
